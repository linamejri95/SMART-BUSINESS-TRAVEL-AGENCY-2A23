...
arduino_voyage::arduino_voyage()
{

}

int arduino_voyage::connect_arduino()
{
...
int arduino_voyage::close_arduino()
{
    if(serial->isOpen())
    {
        serial->close();
...
QString arduino_voyage::read_from_arduino()
{
    QByteArray data="";
    QString output;
...
int arduino_voyage::write_to_arduino(QByteArray d)
{
