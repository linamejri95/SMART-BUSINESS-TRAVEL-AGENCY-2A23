...
#include "ui_statistiquetrans.h"
#include "qcustomplot.h"
#include"QSqlRecord"
#include"QSqlQuery"

statistiquetrans::statistiquetrans(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::statistiquetrans)
{
    ui->setupUi(this);
    makePlot();
...
statistiquetrans::~statistiquetrans()
{
    delete ui;
}

void statistiquetrans::makePlot()
{
    QSqlQuery q2;
